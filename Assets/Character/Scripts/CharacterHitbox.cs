    ...
    private void OnTriggerEnter(Collider trigger)
    {
        if(_Character != null)
        {
            ...
            if (damageableEntity != null && _Character.transform != damageableEntity.GetControllingEntity())
            {
                ...
                Damage dmgObj = new Damage(_Character._AttackController._DamageModifier, _Character._AttackController._Force, _Character._AttackController._IntendedResponseToDamageBeingDealt);
